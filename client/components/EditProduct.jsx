		...
		return (
			<div>
				...
				<form onSubmit={this.handleSubmit}>
					...
					<input name='imUrl' type='text' value={this.state.imUrl} onChange={this.handleChange} required />
					<label>inventory:</label>
					<input name='inventory' type='number' value={this.state.inventory} onChange={this.handleChange} required />
